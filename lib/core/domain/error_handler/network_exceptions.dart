...
abstract class NetworkExceptions with _$NetworkExceptions implements Exception {
  ...
  const factory NetworkExceptions.badRequest(ErrorModel? error) = BadRequest;
  ...
  static List<NetworkExceptions> getAllNetworkExceptions() {
    return [
      const NetworkExceptions.badRequest(null),
  ...
  static NetworkExceptions handleResponse(Response? response) {
    ...
    switch (statusCode) {
      ...
      case 401:
        return NetworkExceptions.unauthorizedRequest(response!.data['error']);
      case 403:
  ...
  static ErrorModel? getError(NetworkExceptions? networkExceptions) {
    ErrorModel? error;
    networkExceptions?.whenOrNull(badRequest: (er) {
      error = er;
    });
    return error;
  }
